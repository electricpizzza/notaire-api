...
export declare class TransactionController {
    ...
    makeTransaction(comptabilite: number, typeTrans: string, service: any, libelle: string, typePay: string, comparent: number, valeur: number, numCheque: number): Promise<{
