...
let ActeController = class ActeController {
    ...
    createActe(libelle, redacteur, contenu, dateRedaction, fichier, model) {
        const acte = new acte_model_1.Acte(null, libelle, redacteur, contenu, dateRedaction, fichier, model);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object, Date, String, Object]),
    __metadata("design:returntype", void 0)
